 ...
 *
 * The key is namespaced by brand, so the Ranktsy → Ranktsy rename would have
...
export const STORAGE_KEY = 'ranktsy:keyword-lists'
export const LISTS_EVENT = 'ranktsy:lists-changed'
