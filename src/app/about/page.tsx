        ...
        <div style={{ background: C.canvas, padding: '40px 40px 96px' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            <div style={{ background: C.charcoal, border: `1px solid ${C.hairInk}`, borderRadius: 40, padding: '72px 48px', textAlign: 'center' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, marginBottom: 20, fontSize: 11.5, fontFamily: "'DM Sans',monospace", fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.09em', color: 'rgba(252,252,247,0.6)' }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: C.orange, display: 'inline-block' }} />
                Get started
              </div>
