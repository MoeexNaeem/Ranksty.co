...
const sections = [
  ...
  },
  {
    ...
    bullets: [
      ...
      { label: 'No Affiliation', text: 'Ranktsy is an independent application. "Etsy" is a trademark of Etsy, Inc. This application uses the Etsy API but is not endorsed or certified by Etsy, Inc.' },
    ],
  },
  {
    number: '08',
