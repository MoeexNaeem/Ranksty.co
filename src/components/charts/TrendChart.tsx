  ...
  const options = useMemo<ChartOptions<'line'>>(() => ({
    ...
    plugins: {
      ...
      tooltip: {
        ...
        titleFont:{ size:12, family:"'DM Sans',sans-serif" }, bodyFont:{ size:12, family:"'DM Sans',sans-serif" },
        cornerRadius:8,
      },
    },
    scales: {
      x: { grid:{ display:false }, border:{ display:false }, ticks:{ font:{ size:11, family:"'DM Sans',sans-serif" }, color:'#93938A' } },
      y: { grid:{ color:'rgba(61,62,59,0.06)' }, border:{ display:false }, ticks:{ font:{ size:11, family:"'DM Sans',sans-serif" }, color:'#93938A', maxTicksLimit:5 } },
    },
  }), [])
