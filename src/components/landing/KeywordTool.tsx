  ...
  return (
    <section id="keywords" style={{ padding: '120px 40px', background: C.canvas }}>
      <Reveal style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 11.5, fontWeight: 500, fontFamily:"'DM Sans',monospace", textTransform: 'uppercase' as const, letterSpacing: '0.09em', color: C.ink, marginBottom: 18 }}>
          ...
          {data && !isLoading && (
            <div>
              <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:16 }}>
                ...
                <span style={{ fontSize:12, color:'#b3b3b3', fontFamily:"'DM Sans',monospace" }}>{data.related.length} keywords found</span>
              </div>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
                {SUGG.map(s => (
                  <button key={s}
                    ...
                    style={{ fontSize: 12.5, fontFamily:"'DM Sans',monospace", color: C.orange, background: 'transparent', border: `1px solid ${C.orange}`, padding: '5px 14px', borderRadius: 100, cursor: 'pointer', transition: 'all 0.15s' }}
