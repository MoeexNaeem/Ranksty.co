...
export const SOCIALS: SocialLink[] = [
  { name: 'youtube',   href: 'https://www.youtube.com/channel/UCN_HqL1neCkrLf_QndBvS5Q', label: 'Ranktsy on YouTube' },
  { name: 'facebook',  href: 'https://www.facebook.com/profile.php?id=61591829587497',   label: 'Ranktsy on Facebook' },
  { name: 'instagram', href: 'https://www.instagram.com/rank.kw/',                       label: 'Ranktsy on Instagram' },
  { name: 'pinterest', href: 'https://www.pinterest.com/ranktsyoffical/_profile/',        label: 'Ranktsy on Pinterest' },
  { name: 'threads',   href: 'https://www.threads.com/@rank.kw',                         label: 'Ranktsy on Threads' },
  { name: 'tiktok',    href: 'https://www.tiktok.com/@ranktsy0',                          label: 'Ranktsy on TikTok' },
]
