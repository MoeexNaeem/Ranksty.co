...
function AuthFormInner({ type, email: initEmail, onNext }: { type: FormType; email?: string; onNext?: (email: string) => void }) {
  ...
  const S = {
    ...
    label: { display:'block', fontSize:11, fontFamily:"'DM Sans',monospace", fontWeight:500, textTransform:'uppercase' as const, letterSpacing:'0.07em', color:'#6E6E64', marginBottom:8 } as const,
    ...
    <div style={S.wrap}>
      <div style={S.card}>
        <Link href="/" style={{ display:'inline-flex', alignItems:'center', gap:8, marginBottom:32, textDecoration:'none' }}>
          <span style={{ display:'inline-flex', alignItems:'center', gap:7, fontSize:11, fontFamily:"'DM Sans',monospace", fontWeight:500, textTransform:'uppercase', letterSpacing:'0.09em', color:'#6E6E64' }}>
